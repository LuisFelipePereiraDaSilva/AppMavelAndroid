...
public class ModelComic {
    ...
    public ModelComic(String id, String name, String description, String image, ArrayList<ModelSerie> series, ArrayList<ModelCreator> creators, ArrayList<ModelCharacter> characters, ArrayList<ModelStorie> stories, ArrayList<ModelEvent> events, String resourceURI) {
        this.id = id;
        this.name = name;
